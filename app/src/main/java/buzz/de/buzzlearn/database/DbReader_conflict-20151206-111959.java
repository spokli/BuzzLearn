...
import buzz.de.buzzlearn.InputActivity;
...
public class DbReader extends AsyncTask<DbReaderInformation, Void, Cursor> {
    ...
    public enum SelectPurpose {CATEGORY_SELECTOR, TEST};
    ...
    protected Cursor doInBackground(DbReaderInformation... values) {
        ...
        FeedReaderDbHelper mDbHelper = new FeedReaderDbHelper(callback.getContext());
